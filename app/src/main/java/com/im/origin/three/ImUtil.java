...
import com.im.origin.im.ui.HomeActivity;
...
public class ImUtil {
    ...
    public static void initNIM() {
        ...
        NIMClient.init(OriginApp.app, loginInfo(), options());
    ...
    private SDKOptions options() {
        ...
        String sdkPath = getAppCacheDir((Context) OriginApp.app) + "/nim"; // 可以不设置，那么将采用默认路径
