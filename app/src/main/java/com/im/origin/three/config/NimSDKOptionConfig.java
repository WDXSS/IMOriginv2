package com.im.origin.three.config;
...
class NimSDKOptionConfig {
    ...
    static SDKOptions getSDKOptions(Context context) {
        ...
        // 通知栏显示用户昵称和头像
        options.userInfoProvider = new NimUserInfoProvider(OriginApp.app);
    ...
    static String getAppCacheDir(Context context) {
        ...
        if (TextUtils.isEmpty(storageRootPath)) {
            ...
            storageRootPath = Environment.getExternalStorageDirectory() + "/" + OriginApp.app.getPackageName();
        }
...
//            //这里是在AndroidManifest中
//            //设置云信SDK的appKey。appKey还可以通过在AndroidManifest文件中，通过meta-data的方式设置。
//            // 如果两处都设置了，取此处的值
